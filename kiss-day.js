document.addEventListener('DOMContentLoaded', function() {
    ...
    const sweetMessages = [
        "Sending you a kiss filled with love! 💋",
        "You're the sweetest kiss in my life! 💖",
        "Every kiss is a sweet memory with you! ✨",
    ...
    // Kissing Booth Game
    const kissingBooth = document.querySelector('.kissing-booth');

    kissingBooth.addEventListener('click', function() {
